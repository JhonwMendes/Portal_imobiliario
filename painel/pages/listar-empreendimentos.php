<div class="box-content">
	...
	<div class="busca">
		...
		<form method="post">
			<input placeholder="Procure pelo Empreendimentos" type="text" name="busca">
	...
	<?php 
		if(isset($_GET['deletar'])){
			...
			Painel::alert('sucesso','O empreendimentos foi deletado com sucesso!');
		}
	...
	<div class="boxes">
		...
		?>
		<div id="item-<?php echo $value['id']; ?>" class="box-wraper" style="padding: 10px 30px;">
			...
			<div style="width: 70%;float: left;border: 0;" class="box-single">
				...
				<div class="body-box">
					...
					<a style="background: #0091ea;" class="btn" item_id="<?php echo $value['id'] ?>" href="<?php echo INCLUDE_PATH_PAINEL ?>visualizar-empreendimento/<?php echo $value['id']; ?>"><i class="fa fa-eye"></i> Visualizar</a>
					</div><!--group-btn-->
				</div><!--body-box-->
			</div><!--box-single-->
			<div class="clear"></div>
